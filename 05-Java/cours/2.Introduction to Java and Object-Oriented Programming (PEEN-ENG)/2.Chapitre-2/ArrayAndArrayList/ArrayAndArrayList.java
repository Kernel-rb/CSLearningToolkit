...
public class ArrayAndArrayList {
	 ...
	 * If the array is empty, returns an empty ArrayList.
	 *
	 * Example(s):
	 * - For a defined array: int[] array = {1, 3, 5, 7, 9, 1, 2, 3, 4, 5};
	 ...
	 *
	 * - For a defined array: int[] array = new int[0];
	 * - Calling maxArray(array) would return an empty ArrayList
	 *
	 * @param array to search
	...
	public ArrayList<Integer> maxArray(int[] array) {
		...
		int m = findMax(array); // Find the maximum number in the array
